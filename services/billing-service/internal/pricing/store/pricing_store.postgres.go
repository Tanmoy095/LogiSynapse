// services/billing-service/internal/pricing/store/pricing_store.postgres.go
...
func (store *PostgresPricingStore) GetPriceRules(ctx context.Context, usageType billingtypes.UsageType, tenantID uuid.UUID, at time.Time) (PriceRule, error) {
	// 	Implementation here
	// Query Strategy:
	// 1. Match Usage Type
